      ...
      <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-150 my-6">
        ...
        <div className="px-6 py-4 bg-white border-b border-slate-200 text-slate-900 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-blue-50 border border-blue-200 flex items-center justify-center text-[#1d4ed8]">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-xs bg-blue-50 text-[#1d4ed8] border border-blue-200 px-2 py-0.5 rounded font-bold">
                  {caseFile.id}
                </span>
                <span className="font-mono text-xs bg-[#1d4ed8] text-white px-2 py-0.5 rounded font-black">
        ...
        <div className="p-6 space-y-5 overflow-y-auto max-h-[75vh]">
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-mono font-bold px-2 py-0.5 rounded bg-blue-50 text-[#1d4ed8] border border-blue-200">
                  {patient.mrn}
                </span>
              </div>
            ...
            <div className="shrink-0 flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 bg-blue-50 hover:bg-blue-100 text-[#1d4ed8] border border-blue-200 text-xs font-semibold rounded-lg shadow-2xs transition-colors cursor-pointer"
              >
          ...
          <div className="p-4 rounded-xl bg-blue-50/70 border border-blue-200/90 space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-blue-900 uppercase tracking-wider flex items-center gap-1.5">
                <Stethoscope className="w-4 h-4 text-[#1d4ed8]" />
                Allotted Doctor &amp; OPD Room
              </span>
              <span className="text-[11px] font-semibold text-[#1d4ed8] bg-white px-2 py-0.5 rounded border border-blue-200">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pt-1">
              <div>
                ...
                <p className="text-xs text-slate-600">
                  Department: <strong className="text-blue-800">{caseFile.department}</strong> • Room:{' '}
              ...
              {onUpdatePatientDoctor && (
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="text-xs bg-white border border-slate-300 rounded-lg px-2 py-1 text-slate-800 focus:ring-1 focus:ring-[#1d4ed8]"
                  >
                    {doctors.map((doc) => (
        ...
        <div className="px-6 py-3.5 bg-slate-50 border-t border-slate-200 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={handlePrint}
              className="flex items-center gap-1.5 px-3 py-1.5 bg-white hover:bg-slate-100 text-slate-700 border border-slate-300 rounded-lg text-xs font-semibold shadow-2xs transition-colors cursor-pointer"
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-1.5 bg-[#1d4ed8] hover:bg-[#1e40af] text-white rounded-lg text-xs font-bold transition-colors cursor-pointer"
            >
              Close
            </button>
          </div>
