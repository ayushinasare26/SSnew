      ...
      <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="p-6 space-y-6 overflow-y-auto max-h-[80vh]">
          ...
          <div
            ...
            className="bg-white border-2 border-slate-200 rounded-2xl p-5 shadow-xs space-y-4 relative overflow-hidden"
          >
            {/* Top hospital identity strip */}
            <div className="flex items-center justify-between border-b border-slate-200 pb-3">
              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-lg bg-blue-50 border border-blue-200 text-[#1d4ed8] flex items-center justify-center font-bold">
              ...
              <div className="text-right">
                <span className="inline-block font-mono text-xs font-black bg-blue-50 text-[#1d4ed8] border border-blue-200 px-2.5 py-1 rounded-md">
                ...
                <div className="grid grid-cols-2 gap-2 text-[11px] pt-1 border-t border-slate-100">
                  <div>
                    ...
                    <span className="font-bold text-slate-800 flex items-center gap-1">
                      <Stethoscope className="w-3 h-3 text-[#1d4ed8]" />
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
            <div className="flex items-center gap-2">
              <button
                type="button"
                onClick={handlePrint}
                className="flex items-center gap-1.5 px-3 py-2 bg-[#1d4ed8] hover:bg-[#1e40af] text-white rounded-lg text-xs font-semibold shadow-xs transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 rounded-lg text-xs font-semibold transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 rounded-lg text-xs font-medium transition-colors cursor-pointer"
              >
                {copied ? (
                  <>
            ...
            {onOpenCaseFile && (
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-2 border border-blue-200 bg-blue-50/50 hover:bg-blue-100 text-[#1d4ed8] rounded-lg text-xs font-semibold shadow-2xs transition-colors cursor-pointer"
              >
