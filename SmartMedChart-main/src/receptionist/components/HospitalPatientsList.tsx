      ...
      <div className="p-5 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-lg text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#1d4ed8] focus:bg-white transition-all"
          />
        </div>
      </div>
                ...
                return (
                  <tr key={p.id} className="hover:bg-slate-50/70 transition-colors">
                    ...
                    <td className="py-3 px-4 whitespace-nowrap">
                      <span className="font-mono text-xs font-bold px-2.5 py-1 rounded-md bg-blue-50 text-[#1d4ed8] border border-blue-200 shadow-2xs">
                        {p.tokenNumber}
                      </span>
                    </td>
                    ...
                    <td className="py-3 px-4 whitespace-nowrap">
                      <div className="flex items-center gap-1.5">
                        <Stethoscope className="w-3.5 h-3.5 text-[#1d4ed8] shrink-0" />
                        <span className="font-bold text-slate-900">
                          {p.caseFile.assignedDoctorName}
                        </span>
                      </div>
                      <div className="text-[11px] text-slate-500 mt-0.5 flex items-center gap-2">
                        <span className="text-blue-800 font-semibold">{p.caseFile.department}</span>
                        <span>•</span>
                      ...
                      <div className="mt-1">
                        <select
                          ...
                          className="text-[10px] bg-slate-50 border border-slate-200 rounded px-1.5 py-0.5 text-slate-700 hover:border-slate-400 focus:outline-none focus:ring-1 focus:ring-[#1d4ed8] font-medium"
                        >
                          {doctors.map((doc) => (
                      ...
                      {isAdmitted && p.admission ? (
                        <div className="space-y-1">
                          ...
                          <button
                            ...
                            className="text-[10px] text-[#1d4ed8] hover:text-[#1e40af] font-bold underline cursor-pointer"
                          >
                            Manage Bed / Shifts
                          </button>
                        </div>
                    ...
                    <td className="py-3 px-4 whitespace-nowrap text-right space-x-1.5">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-blue-50 hover:bg-blue-100 text-[#1d4ed8] border border-blue-200 rounded-lg text-xs font-semibold shadow-2xs transition-colors"
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1 px-2.5 py-1.5 border border-blue-200 bg-blue-50/50 hover:bg-blue-100 text-[#1d4ed8] rounded-lg text-xs font-semibold shadow-2xs transition-colors"
