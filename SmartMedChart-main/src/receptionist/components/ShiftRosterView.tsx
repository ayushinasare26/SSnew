      ...
      <div className="p-5 rounded-2xl bg-white text-slate-900 shadow-xs border border-slate-200 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-blue-50 text-[#0b4da2] border border-blue-200">
              24/7 ROSTER
            </span>
            <span className="text-xs text-slate-500">Continuous Clinical Cover</span>
          </div>
        ...
        <div className="flex items-center gap-2 bg-amber-50 border border-amber-200 p-3 rounded-xl shrink-0">
          <div className="w-2.5 h-2.5 rounded-full bg-amber-500 animate-pulse" />
          <div>
            <span className="text-[10px] text-amber-700 uppercase font-bold block">Current Active Shift</span>
